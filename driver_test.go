...
const rds_dsn = "user:pwd@tcp(host:port)/db?MEK=00112233445566778899aabbccddeeff"
const polar_dsn = "user:pwd@tcp(host:port)/db?MEK=00112233445566778899aabbccddeeff"
